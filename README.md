About convertdate-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/convertdate-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=184&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/convertdate-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `convertdate` can be installed with `conda`:
...
```
mamba install convertdate
```

It is possible to list all of the versions of `convertdate` available on your platform with `conda`:
...
```
mamba search convertdate --channel conda-forge
```
...
mamba repoquery search convertdate --channel conda-forge

# List packages depending on `convertdate`:
mamba repoquery whoneeds convertdate --channel conda-forge

# List dependencies of `convertdate`:
mamba repoquery depends convertdate --channel conda-forge
```
